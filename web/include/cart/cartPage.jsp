...
$(this).parent($(".objOrderItem")).css("display","none");
...
<c:forEach items="${cartList}" var="cart" varStatus="st">
    <div class="objOrderItem">
        ...
        <div>
            ...
            <input type="checkbox" pid="${cart.productId}" selectit="false" oiid="${cart.id}" class="selectOrderItem"
                name="productId" value="${cart.productId}">

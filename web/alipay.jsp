...
<body>
  ...
  <div class="align-items-center d-flex photo-overlay py-5 cover" style="background-image: url(&quot;assets/restaurant/cover_dark.jpg&quot;);">
    <div class="container">
      <div class="row">
        <div class="col-md-3" action="forepayed?oid=${param.oid}&total=${param.total}"> </div>
        <div class="col-lg-6 p-3 animate-in-down">
          <div class="p-4 bg-dark-opaque">
            <h4 class="mb-4 text-center">确认付款</h4>
            <p class="my-4">请核对:共￥ ${param.total}元<br></p>
            <a href="forepayed?oid=${param.oid}&total=${param.total}">
            <button type="submit" class="btn mt-4 btn-block p-2 btn-outline-primary">确认付款</button>
            </a>
            <button type="button" class="btn mt-4 btn-block p-2 btn-outline-primary" style=""><b>返回</b></button>
          </div>
        </div>
      </div>
    </div>
